<div class="container mt-3 text-white">
  ...
  <form action="<?php echo $racine_path; ?>control/utilisateur.php" method="POST">
    <div class="form-floating mb-3 mt-3 align-items-center second-plan text-black">
      <input type="text" class="form-control" id="text" placeholder="Enter Pseudo" name="pseudo" value="<?php echo $cookie_user->pseudo; ?>">
      <label>Pseudo</label>
    </div>
    <div class="form-floating mt-3 mb-3 align-items-center second-plan text-black">
      <input type="text" class="form-control" id="email" placeholder="Enter Email" name="email" value="<?php echo $cookie_user->email; ?>">
      <label>Email</label>
    </div>
    <div class="form-floating mb-3 mt-3 align-items-center second-plan text-black">
